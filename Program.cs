...
namespace CSharpFundamentals
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            StringDemo.ShowStringBuilder(); // Shows StringBuilder for efficient string manipulation
            ...
            // Summarizing Text
            SummarizingText.ShowTextSummarization(); // Demonstrates text summarization
        }
    }
}
